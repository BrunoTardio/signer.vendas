...
public class ClienteEnderecoResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody ClienteEnderecoNewDTO objDto) {
		ClienteEndereco obj = service.fromDTO(objDto); // trouxe um objeto injetando o ClienteEnderecoCategoria com ClienteEndereco
	...
	public ResponseEntity<Void> update(@Valid @RequestBody ClienteEnderecoNewDTO objDto, @PathVariable Integer id){
		ClienteEndereco obj = service.fromDTO(objDto);
		obj.setId(id);
	...
	public ResponseEntity<Page<ClienteEndereco>> findPage(
