...
public class ProdutoCategoriaResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody ProdutoCategoriaDTO objDto) {
		ProdutoCategoria obj = service.fromDTO(objDto);
	...
	public ResponseEntity<Void> update(@Valid @RequestBody ProdutoCategoriaDTO objDto, @PathVariable Integer id){
		ProdutoCategoria obj = service.fromDTO(objDto);
		obj.setId(id);
	...
	public ResponseEntity<Page<ProdutoCategoriaDTO>> findPage(
			@RequestParam(value = "page", defaultValue = "0") Integer page,
			@RequestParam(value = "linesPerPage", defaultValue = "24") Integer linesPerPage,
			@RequestParam(value = "orderBy", defaultValue = "nome") String orderBy,
			@RequestParam(value = "direction", defaultValue = "ASC") String direction) {
		Page<ProdutoCategoria> list = service.findPage(page, linesPerPage, orderBy, direction);
		Page<ProdutoCategoriaDTO> listDto = list.map(obj -> new ProdutoCategoriaDTO(obj));
